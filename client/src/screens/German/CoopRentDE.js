      ...
      <div className='wrapper section'>
        <div className='section'>
          <Container className='col-md-6'>
            <h3 className='title'>So hilft Ihnen DARNA bei der Vermietung</h3>
            <p>
              Die Wohnung steht bereits leer, wird noch renoviert oder wird
              sogar noch vom Mieter bewohnt? <br /> Kein Problem — DARNA findet
              den passenden Nachmieter! DARNA arbeitet schnell, professionell
              und dennoch persönlich. Keine Standard Abfertigung sondern ein
              persönlicher, transparenter und kompetenter Service führt zu einer
              Zufriedenheit bei allen Beteiligten: Hausverwaltungen, Eigentümern
              und Mietern!
            </p>
            <h5 className='title'>
            ...
            <p>
            Wir akzeptieren keinerlei Diskriminierung.
            </p>
            <Button
              href='/en/contact'
              className='btn-round'
